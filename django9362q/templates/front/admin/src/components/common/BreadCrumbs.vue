<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:50px;backgroundColor:rgba(249, 249, 249, 1);borderRadius:4px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px 	#0151A7;borderWidth:0px;borderStyle:dotted solid double dashed;borderColor:rgba(1, 62, 128, 1);">
