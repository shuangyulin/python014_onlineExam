...
def xuesheng_page(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        msg['data']['pageSize']  =xuesheng.page(xuesheng, xuesheng, req_dict, request)
...
def xuesheng_autoSort2(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        leixing = set()
        try:
            cursor.execute("select inteltype from storeup where userid = %d"%(request.session.get("params").get("id"))+" and tablename = 'xuesheng' order by addtime desc")
...
def xuesheng_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/django9362q/xuesheng/notify',
            #notify_url=''
        )
...
def xuesheng_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/django9362q/admin/dist/index.html#/xuesheng')
